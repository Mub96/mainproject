                    ...
                    <input type="hidden" name="id" value="<?php echo $content['id'] ?>" />
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="titleeen" name="titleeen" placeholder="Enter title"  class="form-control col-md-7 col-xs-12" value="<?php echo $content['title'] ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           ...
                           <textarea placeholder="Enter Content" id="editor1" style="width:67%" required   name="contenten"  ><?php echo $content['content'] ?></textarea>
                        </div>
                      </div>
...
$(document).ready(function(e) {
	   ...
	   $("#btnsubmit").click(function(e) {
        ...
        CKEDITOR.instances[instance].updateElement();
  			...
  			var url="<?php echo base_url()?>admin/insurances/addcontent";
  			var redirect = "<?php echo base_url()?>admin/insurances";
