            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form  class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url() ?>admin/about/meet_the_doctor_edit/<?php echo $id ?>" >
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="name" name="name"   class="form-control col-md-7 col-xs-12" value="<?php echo set_value('name',$edit['name']) ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="designation" name="designation"   class="form-control col-md-7 col-xs-12" value="<?php echo set_value('designation',$edit['designation']) ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="experience" name="experience"   class="form-control col-md-7 col-xs-12" value="<?php echo set_value('experience',$edit['experience']) ?>">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="email" id="experience" name="email"   class="form-control col-md-7 col-xs-12" value="<?php echo set_value('email',$edit['email']) ?>">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" placeholder="Enter facebook link"  name="facebook"   class="form-control col-md-7 col-xs-12" value="<?php echo set_value('facebook',$edit['facebook']) ?>">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" placeholder="Enter twitter link"  name="twitter"   class="form-control col-md-7 col-xs-12" value="<?php echo set_value('twitter',$edit['twitter']) ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           ...
                           <textarea placeholder="Enter Content" id="editor1" style="width:67%" required   name="content"  ><?php echo set_value('content',$edit['content']) ?></textarea>
                        </div>
                      </div>
