            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form  class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url() ?>admin/about/meet_the_doctor" >
					  ...
					  <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                         <input type="password" id="cpwd" name="cpwd"   class="form-control col-md-7 col-xs-12" value="<?php echo set_value('email') ?>" placeholder="Confirm Password">
