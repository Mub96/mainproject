   ...
   <!-- Bootstrap -->
    ...
    <!-- Custom Theme Scripts -->
        <script src="<?php echo ADMIN_STYLEPATH?>vendors/bootstrap/dist/js/bootstrap.min.js"></script>

    <script src="<?php echo ADMIN_STYLEPATH?>build/js/custom.min.js"></script>
