        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">
							 <input type="text" id="inp-field-email" name="hspfax" placeholder="Enter Hospital Fax"  class="form-control col-md-7 col-xs-12" value="<?php if($news){echo $news[0]->c_hemail;} ?>">
                         </div>
			</div>
