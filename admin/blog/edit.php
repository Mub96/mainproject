            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="frmblog" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="#" name="frm">
                    <input type="hidden" name="id" value="<?php echo $edit['blog_id'] ?>" />
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Title<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="titleeen" name="titleeen" placeholder="Enter title"  class="form-control col-md-7 col-xs-12" value="<?php echo $edit['title'] ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="keywordsen" name="keywordsen" placeholder="Enter keywords"  class="form-control col-md-7 col-xs-12" value="<?php echo $edit['keywords'] ?>">
                     ...
                     <input type="hidden" name="hidimage" value="<?php// echo $edit['image'] ?>" />
                      ...
                      <div class="form-group">
                        ...
                        <a href="<?php echo ADMIN_PATH?>blog" id="btncancel" class="btn btn-info">Cancel</a>
...
//});			
	   ...
	   $("#btnsubmit").click(function(e) {
        ...
        CKEDITOR.instances[instance].updateElement();
  			...
  			var url="<?php echo base_url()?>admin/blog/editblog";
  			var redirect = "<?php echo base_url()?>admin/blog";
	...
	function validation(){
        ...
        if(values.titleeen == ''){
		   ...
		   if(values.keywordsen == ''){
            $('#keywordsen').addClass('errors');
            $('#keywordsen').attr("placeholder", "Please enter keywords in English")
			$('#keywordsen').css({'border':'1px solid red'});
		    $('#keywordsen').addClass('errorInput');
            error=1;
        }
        return error;
    }
