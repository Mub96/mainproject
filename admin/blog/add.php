                    ...
                    <form id="frmblog" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="#" name="frm">
					  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="titleeen" name="titleeen" placeholder="Enter title"  class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="keywordsen" name="keywordsen" placeholder="Enter keywords"  class="form-control col-md-7 col-xs-12">
...
//});			
	   ...
	   $("#btnsubmit").click(function(e) {
        ...
        CKEDITOR.instances[instance].updateElement();
  			...
  			var url="<?php echo base_url()?>admin/blog/addblog";
  			var redirect = "<?php echo ADMIN_PATH?>blog";
