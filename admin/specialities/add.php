            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br />
                    <form id="frmspecialities" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="#" name="frmspecialities">
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Title<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="text" id="titleeen" name="titleeen" placeholder="Enter Procedures"  class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <img src="<?php echo base_url();?>images/uploads/dummy.png" id="imgfiles" width="100" height="100" style="border:none;">
    ...
    readURL(this);
	   ...
	   $("#btnsubmit").click(function(e) {
        ...
        CKEDITOR.instances[instance].updateElement();
  			...
  			var url="<?php echo ADMIN_PATH?>specialities/addspecialities";
  			var redirect = "<?php echo ADMIN_PATH?>specialities";
  			var form = document.forms.namedItem("frmspecialities");                        
			var oData = new FormData(document.forms.namedItem("frmspecialities"));           
