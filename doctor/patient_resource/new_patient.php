                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <?php if ($this->session->flashdata('msg')) { ?>
                                ...
                                <?php } ?>
                    <br />
                    <form  class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="<?php echo base_url() ?>admin/patient_resources/add" >
                    
                    
					  <input type="hidden" name="id" value="<?php if(isset($content)) echo $content['id'] ?>" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                           ...
                           <textarea placeholder="Enter Content" id="editor1" style="width:67%" required   name="content"  ><?php if(isset($content)) echo $content['content']; ?></textarea>
                        </div>
                      </div>
