                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form  class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="" id="frm" name="frm">
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="treatment" name="treatment" class="form-control col-md-7 col-xs-12" readonly="readonly"><?php echo $details['4']; ?></textarea>
                            
                      </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name" style="color:red;" readonly="readonly">Current Symptoms<span class="required" style="color:red;">*</span>
                        </label>
						 
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="symptoms" name="symptoms" class="form-control col-md-7 col-xs-12" style="height:250px;" readonly="readonly"><?php echo $details['5']; ?></textarea>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="decisions" name="decisions" class="form-control col-md-7 col-xs-12" style="height:200px;" readonly="readonly"><?php echo $details['6']; ?></textarea>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="prescriptions" name="prescriptions" class="form-control col-md-7 col-xs-12" style="height:200px;" readonly="readonly"><?php echo $details['7']; ?></textarea>
                      ...
                      <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="tests" name="tests" class="form-control col-md-7 col-xs-12" style="height:200px;" readonly="readonly"><?php echo $details['8']; ?></textarea>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="imgfile2"  name="imgfile2" class="form-control col-md-7 col-xs-12">
                          <img src="<?php echo base_url();?>images/uploads/dummy.png" id="imgfiles" width="100" height="100" style="border:none;margin-top: 10px;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="imgfile3"  name="imgfile3" class="form-control col-md-7 col-xs-12">
                          <img src="<?php echo base_url();?>images/uploads/dummy.png" id="imgfiles" width="100" height="100" style="border:none;margin-top: 10px;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="imgfile4"  name="imgfile4" class="form-control col-md-7 col-xs-12">
                          <img src="<?php echo base_url();?>images/uploads/dummy.png" id="imgfiles" width="100" height="100" style="border:none;margin-top: 10px;">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="imgfile5"  name="imgfile5" class="form-control col-md-7 col-xs-12">
                          <img src="<?php echo base_url();?>images/uploads/dummy.png" id="imgfiles" width="100" height="100" style="border:none;margin-top: 10px;">
                    ...
                    <!--  <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="imgfile6"  name="imgfile6" class="form-control col-md-7 col-xs-12">
                          <img src="<?php //echo base_url();?>images/uploads/dummy.png" id="imgfiles" width="100" height="100" style="border:none;margin-top: 10px;">
