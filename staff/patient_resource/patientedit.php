                    ...
                    <form  class="form-horizontal form-label-left" enctype="multipart/form-data" method="post" action="" id="frm" name="frm">
					  ...
					  <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                         <input type="text" id="fname" name="fname"   class="form-control col-md-7 col-xs-12" value="<?php echo $details['0'] ?>" placeholder="First Name">
                         <span class="text-error"><?php echo form_error('name'); ?></span>
                          
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                         <input type="text" id="lname" name="lname"   class="form-control col-md-7 col-xs-12" value="<?php echo $details['1'] ?>" placeholder="Last Name">
                         <span class="text-error"><?php echo form_error('name'); ?></span>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="address" name="address" class="form-control col-md-7 col-xs-12"> <?php echo $details['2'] ?> </textarea>
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" id="city" name="city"   class="form-control col-md-7 col-xs-12" value="<?php echo $details['3'] ?>" placeholder="City">
                          <span class="text-error"><?php echo form_error('city'); ?></span> 
                          
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" id="state" name="state"   class="form-control col-md-7 col-xs-12" value="<?php echo $details['4'] ?>" placeholder="State">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" id="zipcode" name="zipcode"   class="form-control col-md-7 col-xs-12" value="<?php echo $details['5'] ?>" placeholder="Zipcode">
                          <span class="text-error"><?php echo form_error('zipcode'); ?></span> 
                          
                        </div>
                        <div class="col-md-3 col-sm-3 col-xs-12">
                          <input type="text" id="mobno" name="mobno"   class="form-control col-md-7 col-xs-12" value="<?php echo $details['6'] ?>" placeholder="Mob No">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <input type="email" id="email" name="email"   class="form-control col-md-7 col-xs-12" value="<?php echo $details['7'] ?>">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                         <textarea id="condition" name="condition" class="form-control col-md-7 col-xs-12"><?php echo $details['8'] ?></textarea>
                        <!-- <input type="text" id="designation" name="designation"   class="form-control col-md-7 col-xs-12" value="<?php //echo set_value('designation') ?>">-->
                        <span class="text-error"><?php echo form_error('address'); ?></span> 
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <img src="<?php echo base_url();?><?php echo $image; ?>" id="imgfiles" width="100" height="100" style="border:none;margin-top: 10px;">
    ...
    readURL(this);
	   ...
	   $("#btnsubmit").click(function(e) {
        ...
        CKEDITOR.instances[instance].updateElement();
  			...
  			var url="<?php echo base_url()?>admin/patient_resources/updatePatient";
