...
class Patient_resources extends CI_Controller {
	 function __construct(){
        parent::__construct();
		$this->load->model('staff/Patient_resource_model');
	 }
	public function index()
	{
		...
		$this->load->view('staff/patient_resource/new_patient',$data);
		$this->load->view('admin/footer');	 	
	}
	public function patientregistration(){
		$data['title']='Patient Registration' ;
	    $this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/patientregistration',$data);
		$this->load->view('admin/footer');	
		}
	public function patientlist(){
	    ...
	    $this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/patient_list',$data);
		$this->load->view('admin/footer');
		}
	public function reportList(){
		$data['title']='Report List' ;
		$data['details']=$this->Patient_resource_model->getReportdetails();
	    $this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/report_list',$data);
		$this->load->view('admin/footer');
		}
	public function allReports(){
	    ...
	    $this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/allReports',$data);
		$this->load->view('admin/footer');
		}
	public function editPatient($id=false){
		...
		$data['details']=$ar;
		$this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/patientedit',$data);
		$this->load->view('admin/footer');	
		}
	public function patientReport(){
		...
		if(isset($dataimg['upload_data']['file_name'])){
				 $path1='images/resource/'.$dataimg['upload_data']['file_name'];		
			}else{
				 $path1='images/uploads/dummy.png';		
			}
		...
		$config['upload_path'] = './images/resource/';
            $config['allowed_types'] = 'gif|jpg|png';
            $this->load->library('upload', $config);
            if ( ! $this->upload->do_upload('imgfile2')) {
            $error = array('error' => $this->upload->display_errors());
            } 
			else 
			{
		...
		if(isset($dataimg['upload_data']['file_name'])){
				 $path2='images/resource/'.$dataimg['upload_data']['file_name'];		
			}else{
				 $path2='images/uploads/dummy.png';		
			}
		...
		$config['upload_path'] = './images/resource/';
            $config['allowed_types'] = 'gif|jpg|png';
            $this->load->library('upload', $config);
            if ( ! $this->upload->do_upload('imgfile3')) {
            $error = array('error' => $this->upload->display_errors());
            } 
			else 
			{
		...
		if(isset($dataimg['upload_data']['file_name'])){
				 $path3='images/resource/'.$dataimg['upload_data']['file_name'];		
			}else{
				 $path3='images/uploads/dummy.png';		
			}
		...
		$config['upload_path'] = './images/resource/';
            $config['allowed_types'] = 'gif|jpg|png';
            $this->load->library('upload', $config);
            if ( ! $this->upload->do_upload('imgfile4')) {
            $error = array('error' => $this->upload->display_errors());
            } 
			else 
			{
		...
		if(isset($dataimg['upload_data']['file_name'])){
				 $path4='images/resource/'.$dataimg['upload_data']['file_name'];		
			}else{
				 $path4='images/uploads/dummy.png';		
			}
		...
		$config['upload_path'] = './images/resource/';
            $config['allowed_types'] = 'gif|jpg|png';
            $this->load->library('upload', $config);
            if ( ! $this->upload->do_upload('imgfile5')) {
            $error = array('error' => $this->upload->display_errors());
            } 
			else 
			{
		...
		if(isset($dataimg['upload_data']['file_name'])){
				 $path5='images/resource/'.$dataimg['upload_data']['file_name'];		
			}else{
				 $path5='images/uploads/dummy.png';		
			}
		...
		/*$config['upload_path'] = './images/resource/';
            $config['allowed_types'] = 'gif|jpg|png';
            $this->load->library('upload', $config);
            if ( ! $this->upload->do_upload('imgfile6')) {
            $error = array('error' => $this->upload->display_errors());
            } 
			else 
			{
		...
		if(isset($dataimg['upload_data']['file_name'])){
				 $path6='images/resource/'.$dataimg['upload_data']['file_name'];		
			}else{
				 $path6='images/uploads/dummy.png';		
			}*/
		...
		$data=array($name,$doctor,$token,$opno,$staff,$path1,$path2,$path3,$path4,$path5);
		$newreg=implode('/',$data);
		
		//echo $newreg;
		
		$this->Patient_resource_model->addReportdetails($newreg);
		}
	...
	public function add()
	{
		...
		redirect('staff/patient_resources');
		}
	...
	public function appointment()
	{
	    ...
	    $this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/appointment_list',$data);
		$this->load->view('admin/footer');	 	
	}
	...
	public function get_pdf($id)
	{
        ...
        $html = $this->load->view('staff/patient_resource/pdf', $data, true);
	...
	public function remove($id)
	{
		...
		redirect('staff/patient_resources/patientlist');
	}
	public function viewPatient($id){
		...
		$this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/patientview',$data);
		$this->load->view('admin/footer');	
		}
	public function viewQuery($id){
		$data['title']='View Patient' ;
		$detail=$this->Patient_resource_model->getQuery($id);
		$value=dycrypt($detail['value']);
		$ar=explode('/',$value);
		$data['id']=$detail['id'];
		$data['details']=$ar;
		...
		$data['doctor']=$this->Patient_resource_model->doctorDetails();
		$this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/appointEdit',$data);
		$this->load->view('admin/footer');	
		}
	public function viewallQuery($id){
		...
		$data['doctor']=$this->Patient_resource_model->doctorDetails();
		$this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/appointReport',$data);
		$this->load->view('admin/footer');	
		}
	...
	public function appointList(){
	    ...
	    $this->load->view('admin/header',$data);
		$this->load->view('staff/patient_resource/appoint_list',$data);
		$this->load->view('admin/footer');
		}
	...
	public function removeApt($id){
		...
		redirect('staff/patient_resources/appointList');
		}
