...
class Patient_resources extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/patient_resource/new_patient',$data);
		$this->load->view('admin/footer');	 	
	}
	public function patientregistration(){
		$data['title']='Patient Registration' ;
	    $this->load->view('admin/header',$data);
		$this->load->view('admin/patient_resource/patientregistration',$data);
		$this->load->view('admin/footer');	
		}
	public function patientlist(){
	    ...
	    $this->load->view('admin/header',$data);
		$this->load->view('admin/patient_resource/patient_list',$data);
		$this->load->view('admin/footer');
		}
	public function editPatient($id=false){
		...
		$data['details']=$ar;
		$this->load->view('admin/header',$data);
		$this->load->view('admin/patient_resource/patientedit',$data);
		$this->load->view('admin/footer');	
		}
	...
	public function appointment()
	{
	    ...
	    $this->load->view('admin/header',$data);
		$this->load->view('admin/patient_resource/appointment_list',$data);
		$this->load->view('admin/footer');	 	
	}
	...
	public function remove($id)
	{
		...
		redirect('admin/patient_resources/patientlist');
	}
	public function viewPatient($id){
		...
		$this->load->view('admin/header',$data);
		$this->load->view('admin/patient_resource/patientview',$data);
		$this->load->view('admin/footer');	
		}
	...
	public function appointList(){
	    ...
	    $this->load->view('admin/header',$data);
		$this->load->view('admin/patient_resource/appoint_list',$data);
		$this->load->view('admin/footer');
		}
	public function editAppointment($id=false){
		...
		$this->load->view('admin/header',$data);
		$this->load->view('admin/patient_resource/appointEdit',$data);
		$this->load->view('admin/footer');	
		}
	...
	public function removeApt($id){
		...
		redirect('admin/patient_resources/appointList');
		}
